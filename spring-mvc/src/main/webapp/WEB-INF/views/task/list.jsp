...
<div class="container">
	...
	<hr />
	<p class="text-right">
		<a class="btn btn-primary" href="tasks/new" role="button">Create New Task</a>
		<button class="btn btn-primary" id="tasksJSON"  role="button">Task JSON</button>
		<script>
			$(document).ready(function () {
				$.get("/tasks.json", function (data) {
				    $("#tasksJSON").click(function () {
                        var taskJSON = JSON.stringify(data);
                        alert(taskJSON);
                    });
                },"json");
            });
